...
volatile uint8_t sht40_present = 1;
volatile uint8_t bme280_present = 1;
...
volatile uint32_t btn1_last_tick = 0;
volatile uint32_t btn2_last_tick = 0;
...
volatile uint8_t rgb_brightness = 0;
