...
export default function AdminFunctionalityDefinitionTable({
	...
	useEffect(() => {
		localStorage.setItem('functionalityDefinitionTableSortModel', JSON.stringify(sortModel))
	}, [sortModel])

	useEffect(() => {
		localStorage.setItem('functionalityDefinitionTableFilterModel', JSON.stringify(filterModel))
	}, [filterModel])
